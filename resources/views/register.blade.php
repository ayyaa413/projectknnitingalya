    ...
    <div class="login-container">
        ...
        <form>
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password" placeholder="Enter your konfirmasi password">
            </div>
            <button type="submit" class="btn btn-login w-100">
                <a href="/admin/dashboard" class="btn btn-login-choice">LOGIN</a></button>
        </form>
        </form>
    </div>
</body>
